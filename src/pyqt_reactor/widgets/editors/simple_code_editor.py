...
class QScintillaCodeEditorDialog(QDialog):
    ...
    def _setup_ui(self, initial_content: str):
        ...
        from pyqt_reactor.widgets.llm_chat_panel import LLMChatPanel
    ...
    def _open_file(self):
        ...
        from pyqt_reactor.core.path_cache import PathCacheKey, get_cached_dialog_path, cache_dialog_path
