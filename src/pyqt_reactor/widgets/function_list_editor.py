...
from pyqt_reactor.services.pattern_data_manager import PatternDataManager
from pyqt_reactor.widgets.function_pane import FunctionPaneWidget
from objectstate import ObjectStateRegistry
from pyqt_reactor.theming import ColorScheme
from pyqt_reactor.forms.widget_strategies import _get_enum_display_text
...
class FunctionListEditorWidget(QWidget):
    ...
    def _generate_complete_python_code(self) -> str:
        ...
        from pyqt_reactor.protocols import get_codegen_provider
    ...
    def _apply_scope_styling_to_children(self, scheme) -> None:
        ...
        from pyqt_reactor.widgets.shared.clickable_help_components import HelpButton, HelpIndicator, GroupBoxWithHelp
        from pyqt_reactor.widgets.shared.scope_color_utils import tint_color_perceptual
