...
class FunctionPaneWidget(QWidget):
    ...
    def create_combined_header(self) -> QWidget:
        ...
        if self.func:
            ...
            from pyqt_reactor.widgets.shared.clickable_help_components import HelpIndicator
    ...
    def create_parameter_form(self) -> QWidget:
        ...
        from pyqt_reactor.forms import ParameterFormManager as PyQtParameterFormManager, FormManagerConfig
    ...
    def create_parameter_widget(self, param_name: str, param_type: type, current_value: Any) -> Optional[QWidget]:
        ...
        # Enum parameters
            ...
            from pyqt_reactor.forms.widget_strategies import create_enum_widget_unified
