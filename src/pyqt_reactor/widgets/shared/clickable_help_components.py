    ...
    def mousePressEvent(self, event):
        ...
        if event.button() == Qt.MouseButton.LeftButton:
            try:
                ...
                from pyqt_reactor.windows.help_window_manager import HelpWindowManager
...
class GroupBoxWithHelp(FlashableGroupBox):
    ...
    def _paint_scope_background(self, layers) -> None:
        ...
        from pyqt_reactor.widgets.shared.scope_visual_config import ScopeVisualConfig
        from pyqt_reactor.animation import get_widget_corner_radius, DEFAULT_CORNER_RADIUS
