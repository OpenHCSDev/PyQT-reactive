...
from pyqt_reactor.widgets.shared.list_item_delegate import (
...
from pyqt_reactor.widgets.mixins import (
...
from pyqt_reactor.animation import FlashMixin, get_flash_color, WindowFlashOverlay
...
class AbstractManagerWidget(QWidget, CrossWindowPreviewMixin, FlashMixin, ABC, metaclass=_CombinedMeta):
    ...
    def _get_default_gui_config(self):
        ...
        from pyqt_reactor.protocols import get_form_config
    ...
    def _get_code_content(self) -> str:
        ...
        PipelineEditor implementation:
            from pyqt_reactor.core.code_generator import generate_complete_pipeline_steps_code
    ...
    def _subscribe_flash_for_item(self, item: Any, list_item: QListWidgetItem, scope_id: str = None) -> None:
        ...
        from pyqt_reactor.animation import FlashElement, WindowFlashOverlay
    ...
    def _apply_list_item_scope_color(self, list_item: QListWidgetItem, item: Any, index: int) -> None:
        ...
        from pyqt_reactor.widgets.shared.scope_color_utils import get_scope_color_scheme
        from pyqt_reactor.widgets.shared.list_item_delegate import FLASH_KEY_ROLE
    ...
    def update_item_list(self) -> None:
        ...
        """
        from pyqt_reactor.widgets.mixins import preserve_selection_during_update
    ...
    def _build_preview_segments(
        ...
        from pyqt_reactor.protocols import PreviewFormatterRegistry
