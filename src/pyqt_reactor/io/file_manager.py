...
from pyqt_reactor.io.defaults import DEFAULT_IMAGE_EXTENSIONS
from pyqt_reactor.io.base import DataSink
from pyqt_reactor.io.exceptions import StorageResolutionError
...
class FileManager:
    ...
    def list_image_files(self, directory: Union[str, Path], backend: str,
        ...
        from pyqt_reactor.core.sort_utils import natural_sort
