...
from pyqt_reactor.animation.flash_config import FlashConfig, get_flash_config
...
def create_list_item_element(key: str, list_widget: 'QListWidget', get_row: Callable[[], int]) -> FlashElement:
    ...
    try:
        from pyqt_reactor.widgets.shared.list_item_delegate import SCOPE_SCHEME_ROLE
    except ImportError:
...
class _GlobalFlashCoordinator:
    ...
    def _compute_base_color_for_key(self, key: str) -> QColor:
        ...
        try:
            ...
            from pyqt_reactor.widgets.shared.scope_color_utils import (
