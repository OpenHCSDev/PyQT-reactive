...
class WidgetService:
    ...
    def __init__(self):
        ...
        from pyqt_reactor.forms.widget_operations import WidgetOperations
    ...
    def find_group_box(container: QWidget, group_box_type: Type = None) -> Optional[QWidget]:
        ...
        if group_box_type is None:
            try:
                from pyqt_reactor.widgets.shared.clickable_help_components import GroupBoxWithHelp
    ...
    def _apply_context_behavior(
        ...
        if value is None:
            ...
            from pyqt_reactor.forms.parameter_form_manager import ParameterFormManager
    ...
    def get_widget_value(self, widget: QWidget) -> Any:
        ...
        from pyqt_reactor.protocols.widget_protocols import ValueGettable
