...
from pyqt_reactor.widgets import (
    NoScrollSpinBox, NoScrollDoubleSpinBox, NoScrollComboBox
)
from pyqt_reactor.widgets.enhanced_path_widget import EnhancedPathWidget
from pyqt_reactor.theming.color_scheme import ColorScheme as PyQt6ColorScheme
from pyqt_reactor.forms.widget_creation_registry import resolve_optional, is_enum, is_list_of_enums, get_enum_from_list
...
from pyqt_reactor.protocols.widget_protocols import ValueGettable, ValueSettable
...
def create_enum_widget_unified(enum_type: Type, current_value: Any, **kwargs) -> QComboBox:
    ...
    from pyqt_reactor.forms.ui_utils import format_enum_display
...
class MagicGuiWidgetFactory:
    ...
    def _create_checkbox_group_widget(self, param_name: str, param_type: Type, current_value: Any):
        ...
        """
        from pyqt_reactor.widgets import NoneAwareCheckBox
        from pyqt_reactor.protocols.widget_adapters import CheckboxGroupAdapter
        ...
        try:
            ...
            if hasattr(global_config, field_name):
                ...
                if hasattr(field_value, 'name'):  # Enum
                    from pyqt_reactor.forms.ui_utils import format_enum_placeholder
