...
from pyqt_reactor.services import ValueCollectionService
from pyqt_reactor.services import SignalService
from pyqt_reactor.services import FieldChangeDispatcher, FieldChangeEvent
# LiveContextService deleted - functionality moved to ObjectStateRegistry
from pyqt_reactor.services import FlagContextManager
from .form_init_service import FormBuildOrchestrator
from contextlib import contextmanager

try:
    from pyqt_reactor.core.performance_monitor import timer
...
class ParameterFormManager(QWidget, ParameterFormManagerABC, FlashMixin, metaclass=_CombinedMeta):
    ...
    def __init__(self, state: 'ObjectState', config: Optional[FormManagerConfig] = None):
        ...
        with timer(f"ParameterFormManager.__init__ ({derived_field_id})", threshold_ms=5.0):
            ...
            with timer("  Build config", threshold_ms=5.0):
                from pyqt_reactor.forms.parameter_form_service import ParameterFormService
                from pyqt_reactor.forms.form_init_service import (
            ...
            with timer("  Initialize services", threshold_ms=1.0):
                from pyqt_reactor.forms.form_init_service import ServiceFactoryService
    ...
    def setup_ui(self):
        ...
        with timer("    Style generation", threshold_ms=1.0):
            from pyqt_reactor.theming.style_generator import StyleSheetGenerator
    ...
    def _create_widget_for_param(self, param_info: Any) -> Any:
        ...
        from pyqt_reactor.forms.widget_creation_config import create_widget_parametric
    ...
    def _convert_widget_value(self, value: Any, param_name: str) -> Any:
        ...
        """
        from pyqt_reactor.forms.widget_strategies import convert_widget_value_to_type
    ...
    def update_parameter(self, param_name: str, value: Any) -> None:
        ...
        if param_name in self.widgets:
            ...
            from pyqt_reactor.protocols.widget_protocols import ValueSettable
