...
class ContextLayerType(Enum):
    ...
    4. PARENT_OVERLAY - Parent's user-modified values for sibling inheritance
    5. CURRENT_OVERLAY - Current form values (always applied last)
    """
...
class CurrentOverlayBuilder(ContextLayerBuilder):
    ...
    def _dict_to_instance(self, manager: 'ParameterFormManager', overlay: dict) -> Any:
        ...
        for excluded_param in manager.exclude_params:
        ...
        try:
            ...
            from types import SimpleNamespace
            filtered_overlay = {k: v for k, v in overlay.items() if k not in manager.exclude_params}
...
# Apply metaclass to ContextLayerBuilder
ContextLayerBuilder.__class__ = ContextLayerBuilderMeta


# ============================================================================
# GLOBAL REGISTRY - Auto-populated by metaclass
# ============================================================================
