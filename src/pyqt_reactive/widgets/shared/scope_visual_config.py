...
class ScopeVisualConfig:
    ...
    LIST_ITEM_LEADING_MARKER_COLOR_RGB: tuple[int, int, int] = (0, 230, 118)
    LIST_ITEM_LEADING_MARKER_GUTTER_WIDTH_PX: int = 18
    LIST_ITEM_LEADING_MARKER_STRIPE_LEFT_PX: int = 2
    LIST_ITEM_LEADING_MARKER_STRIPE_TOP_MARGIN_PX: int = 3
    LIST_ITEM_LEADING_MARKER_STRIPE_WIDTH_PX: int = 4
    LIST_ITEM_LEADING_MARKER_STRIPE_RADIUS_PX: int = 2
    LIST_ITEM_LEADING_MARKER_TRIANGLE_LEFT_PX: int = 9
    LIST_ITEM_LEADING_MARKER_TRIANGLE_WIDTH_PX: int = 8
    LIST_ITEM_LEADING_MARKER_TRIANGLE_HALF_HEIGHT_PX: int = 6
